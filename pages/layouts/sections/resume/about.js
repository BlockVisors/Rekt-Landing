                ...
                <Row>
                    <Col md="8" className="offset-md-2">
                        ...
                        <div className="sub-title">
                            ...
                            <h1><span className="bold-text2">Sale Start Date: October 26, 2020 16:00 UTC</span></h1>
                         <h1><span className="bold-text2">Sale End Date: October 27, 2020 16:00 UTC</span></h1>
